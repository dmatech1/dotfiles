...
Enable-Log "Microsoft-Windows-Bluetooth-Policy/Operational"             -SizeKB 2048    # ...
...
Enable-Log "Microsoft-Windows-Storage-ATAPort/Admin"                    -SizeKB 2048    # ...
Enable-Log "Microsoft-Windows-Storage-ATAPort/Operational"              -SizeKB 2048    # ...
